...
# spain_sales_report_v5_kedro documentation build
...
from spain_sales_report_v5_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "spain_sales_report_v5_kedro"
author = "Kedro"
...
htmlhelp_basename = "spain_sales_report_v5_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "spain_sales_report_v5_kedro.tex",
        "spain_sales_report_v5_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spain_sales_report_v5_kedro",
        "Project spain_sales_report_v5_kedro codebase.",
        "Data-Science",
    )
]
